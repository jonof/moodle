...
$string['printpreviewnavmethodwrong'] = 'View for printing is not available for a sequential quiz.';
$string['printpreviewshowanswers'] = 'Show correct answers';
$string['printpreviewhideanswers'] = 'Hide answers';
